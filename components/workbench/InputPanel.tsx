...
export function InputPanel({
  ...
  return (
    <div className="inputPanel">
      {/* capital_amount */}
      <div className="field">
        <label htmlFor={capitalId}>투자 가능 금액</label>
        <input
          id={capitalId}
          type="number"
          inputMode="decimal"
        ...
        {errors.capital_amount ? (
          <p id={`${capitalId}-helper`} className="helper is-critical">
            {errors.capital_amount}
          </p>
        ) : (
      ...
      <div className="field field-full">
        <label htmlFor={returnId}>목표 수익률 (%)</label>
        <input
          id={returnId}
          type="number"
          inputMode="decimal"
        ...
        {errors.target_return_pct ? (
          <p id={`${returnId}-helper`} className="helper is-critical">
            {errors.target_return_pct}
          </p>
        ) : (
      ...
      {/* target_period_days */}
      <div className="field">
        <label htmlFor={periodId}>목표 기간</label>
        <input
          id={periodId}
          type="number"
          inputMode="numeric"
        ...
        {errors.target_period_days ? (
          <p id={`${periodId}-helper`} className="helper is-critical">
            {errors.target_period_days}
          </p>
        ) : (
      ...
      {/* max_loss_pct */}
      <div className="field">
        <label htmlFor={lossId}>거래당 최대 손실률</label>
        <input
          id={lossId}
          type="number"
          inputMode="decimal"
        ...
        />
        {errors.max_loss_pct ? (
          <p id={`${lossId}-helper`} className="helper is-critical">
            {errors.max_loss_pct}
          </p>
        ) : (
